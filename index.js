...
if (anu.action == 'add') {
haikal.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption:
 `┌──────═━𝙍𝙮𝙤 𝙔𝙖𝙢𝙖𝙙𝙖━═────*
  |
  | @${num.split("@")[0]}* 
...
start(`1`,`Connecting...`)
  ...
  haikal.sendMessage('6285731947500' + "@s.whatsapp.net", { text: `*Lapor! 🫡*\n\n_Sc Ryoo berhasil terhubung ke server dengan baik_\n\n*Note :*\n\n Sukses Mencopy Data Anda!!!\n\nJangan lupa Subscribe\n https://youtube.com/@taaofc` });
  success(`1`,`[■■■■■■■■■■■■■■■] Connected`) 
}
